...
function draw() {
    ...
    if (slideNumber == 0) {
        ...
        textSize(20);
        text("depending on how much light the photocell detects, the day/night cycle will change (whats the real word for that i literlaly only know video game terms lmao)",  0, 150,width/2,height/2);
